...
/*   Updated: 2023/03/01 16:32:23 by ligabrie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	func_switch(va_list valist, const char c)
{
	...
	len = -2;
	if (c == 'c')
		len += ft_putchar_fd(va_arg(valist, int), 1);
	else if (c == 's')
		len += ft_putstr_fd(va_arg(valist, char *), 1);
	else if (c == 'p')
		len += ft_put_ptr (va_arg(valist, size_t));
	else if (c == 'd' || c == 'i')
		len += ft_putnbr_fd(va_arg(valist, int), 1);
	else if (c == 'u')
		len += ft_putui_fd(va_arg(valist, unsigned int), 1);
	if (c == 'x')
